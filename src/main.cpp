...
int main() {
  ...
  PathPlanner pathPlanner = PathPlanner(map_waypoints_x, map_waypoints_y, map_waypoints_s, map_waypoints_dx, map_waypoints_dy);
        ...
        if (event == "telemetry") {
          ...
          for (int i = 0; i < planned_path.size(); i++) {
            if (i % 2 == 0) {
              ...
              next_y_vals.push_back(planned_path[i]);
            }
          }
